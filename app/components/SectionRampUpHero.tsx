  ...
  return (
    ...
    >
      <div className="relative z-[2] flex flex-col items-center gap-[18px] max-w-[760px] mx-auto">
        <div className="text-white font-bold text-[clamp(18px,2.4vw,24px)] tracking-[6px]">— 2026 —</div>
        <img
          src={logo}
        ...
        <p className="m-0 text-[#FFF3D6] font-semibold text-[clamp(17px,2.2vw,23px)]">
          Ladysmith Days is back <strong className="text-white">August 1–2, 2026</strong>. Full schedule
          drops soon.
        </p>
        ...
        {over ? (
          ...
          <div className="rounded-2xl px-[26px] py-4 shadow-[0_12px_30px_rgba(90,40,10,.25)] bg-[#1E40AF]">
            <div
              className="grid grid-cols-4 gap-3.5 text-white text-center uppercase"
...
export default SectionRampUpHero
